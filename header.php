...
<!--<div class="social">
    <span class="av_font_icon avia_animate_when_visible  av-icon-style-  av-no-color " style="">
    
        <a href='https://www.facebook.com/NoremeadEastFarm/'   class='av-icon-char' style='font-size:40px;line-height:40px;' aria-hidden='true' data-av_icon='' data-av_iconfont='entypo-fontello' > 
        </a>
